...
Last updated: 2026-07-06 13:23 Asia/Shanghai
Archive days kept: 4
...
7. **Dense Structural Priors for Sparse Functional Landmark Localization in Surgical Videos**
   - Source: arXiv, 2026-06-30
...
8. **WaterGen: Decoupling Scene and Medium in Underwater Image Generation**
   - Source: arXiv, 2026-06-30
...
9. **SonoCLIP: Mask-Guided Region-Aware Vision-Language Pretraining for Fetal Ultrasound Analysis**
...
16. **End-to-End LiDAR-Camera Calibration via Multi-Modal Correspondences Estimation and Explicit BEV Alignment**
...
22. **From Gaze to Insight: Bridging Human Visual Attention and Vision Language Model Explanation for Weakly-Supervised Medical Image Segmentation**
   - Source: Semantic Scholar / IEEE Transactions on Medical Imaging / citations 16, 2025-04-15
   - Authors: Jingkun Chen, Haoran Duan, Xiao Zhang, Boyang Gao, Vicente Grau et al.
   - Tags: unsupervised, VLM/MLLM, medical imaging
   - Links: [paper](https://www.semanticscholar.org/paper/1a82752a5b9c39f41f6b275cebee1dce882348be)
   - 论文：From Gaze to Insight: Bridging Human Visual Attention and Vision Language Model Explanation for Weakly-Supervised Medical Image Segmentation
   - 一句话总结：Medical image segmentation remains challenging due to the high cost of pixel-level annotations for training. In the context of weak supervision, clinician gaze data captures regions of diagnostic interest; how...
   - 任务设定：基础模型驱动的视觉定位/分割/推理，可用于自动提示生成或 mask 筛选。
   - 方法核心：视觉-语言对齐，把语义文本信息引入检测或分割。
   - 实验结论：可能包含新数据集/基准；适合看评测协议、失败案例和是否能服务 COD。
   - 和我课题的关系：可用于伪装目标的语义描述、环境理解和候选区域判断。
...
20. **CamoNAS: Neural Architecture Search for Enhanced Camouflaged Object Detection**
   - Source: arXiv, 2026-07-02
   - Authors: Dawei Ren, Yan Zhang, Hongying Tang, Qiaoling Zhou, Jianpo Liu
   - Tags: COD, diffusion, boundary/frequency
   - Links: [paper](http://arxiv.org/abs/2607.01870v1) / [pdf](http://arxiv.org/pdf/2607.01870v1)
...
21. **When SAM2 Meets Video Camouflaged Object Segmentation: A Comprehensive Evaluation and Adaptation**
...
22. **SAM Fails to Segment Anything? -- SAM-Adapter: Adapting SAM in Underperformed Scenes: Camouflage, Shadow, Medical Image Segmentation, and More**
...
23. **C3Net: Context-Contrast Network for Camouflaged Object Detection**
...
24. **SAM2-UNet: Segment Anything 2 Makes Strong Encoder for Natural and Medical Image Segmentation**
...
25. **Weakly Supervised Camouflaged Object Detection Based on the SAM Model and Mask Guidance**
...
26. **Exploring Boundary-Aware Spatial-Frequency Fusion for Camouflaged Object Detection**
...
27. **IP-SAM: Prompt-Space Conditioning for Prompt-Absent Camouflaged Object Detection**
...
28. **Language-Guided Structure-Aware Network for Camouflaged Object Detection**
...
29. **HVPNet: A Bio-Inspired Network for General Salient and Camouflaged Object Detection**
   - Source: arXiv, 2026-06-30
   - Authors: Jiawei Xu, Qiangqiang Zhou, Zhouping Li, Yanjiao Shi, Yugen Yi et al.
   - Tags: COD, saliency/transparent
   - Links: [paper](http://arxiv.org/abs/2606.31496v1) / [pdf](http://arxiv.org/pdf/2606.31496v1)
...
30. **Beyond Single Images: Retrieval Self-Augmented Unsupervised Camouflaged Object Detection**
...
31. **HyperCOD: The First Challenging Benchmark and Baseline for Hyperspectral Camouflaged Object Detection**
...
32. **DGA-Net: Enhancing SAM with Depth Prompting and Graph-Anchor Guidance for Camouflaged Object Detection**
...
33. **Phantom-Insight: Adaptive Multi-cue Fusion for Video Camouflaged Object Detection with Multimodal LLM**
...
34. **Improving SAM for Camouflaged Object Detection via Dual Stream Adapters**
...
35. **Refining Context-Entangled Content Segmentation via Curriculum Selection and Anti-Curriculum Promotion**
...
13. **MV-GEL: Language-Driven Multi-View Geometric Entity Localization on Meshes**
   - Source: arXiv, 2026-06-30
   - Authors: Kartik Bali, Roland Aydin
   - Tags: reasoning, diffusion, boundary/frequency, depth/geometry
   - Links: [paper](http://arxiv.org/abs/2606.31533v1) / [pdf](http://arxiv.org/pdf/2606.31533v1)
...
14. **SonoCLIP: Mask-Guided Region-Aware Vision-Language Pretraining for Fetal Ultrasound Analysis**
   - Source: arXiv, 2026-06-28
   - Authors: Hang Su, Chao Sun, Zhaofan Li, Wei Hu, Juhua Liu et al.
   - Tags: VLM/MLLM, medical imaging
   - Links: [paper](http://arxiv.org/abs/2606.29586v1) / [pdf](http://arxiv.org/pdf/2606.29586v1)
...
31. **Bridging 3D Gaussians and Semantic Occupancy for Comprehensive Open-Vocabulary Scene Understanding from Unposed Images**
   ...
   - Links: [paper](http://arxiv.org/abs/2607.01633v1) / [pdf](http://arxiv.org/pdf/2607.01633v1)
   - 论文：Bridging 3D Gaussians and Semantic Occupancy for Comprehensive Open-Vocabulary Scene Understanding from Unposed Images
   - 一句话总结：Comprehensive 3D scene understanding from sparse, unposed images requires a model to recover renderable geometry, open-vocabulary semantics, and free/occupied 3D space without relying on external camera calibr...
   - 任务设定：开放词汇视觉识别/分割，目标类别或文本提示在训练时未必出现。
   - 方法核心：几何/深度线索建模，可能补充 RGB 外的结构先验。
   - 实验结论：摘要未给出强实验信号；先看实验表格和图 1，再决定是否精读。
   - 和我课题的关系：适合拓展到开放词汇、零样本或少标注 COD。
...
35. **Jolia: Concept-Level Vision-Language Alignment for 3D CT Contrastive Learning**
   - Source: arXiv, 2026-06-23
...
36. **Interpretation-Oriented Cloud Removal via Observation-Anchored Residual Flow with Geo-Contextual Alignment**
   - Source: arXiv, 2026-07-02
   - Authors: Ziyao Wang, Maonan Wang, Yucheng He, Xianping Ma, Ziyi Wang et al.
   - Tags: diffusion, remote sensing
   - Links: [paper](http://arxiv.org/abs/2607.02471v1) / [pdf](http://arxiv.org/pdf/2607.02471v1)
   - 论文：Interpretation-Oriented Cloud Removal via Observation-Anchored Residual Flow with Geo-Contextual Alignment
   - 一句话总结：Cloud removal (CR) is essential for optical remote sensing, serving as a prerequisite for reliable downstream interpretation, such as semantic segmentation and change detection. However, existing CR approaches...
...
42. **Controllable Histopathology Image Synthesis with Training-free Structural Initialization and Textural Modulation**
   - Source: arXiv, 2026-06-26
...
43. **MLFFM-SegDiff: A Multi-Level Feature Fusion Diffusion Model for Skin Lesion Segmentation**
   - Source: arXiv, 2026-06-25
...
44. **High-Fidelity Synthetic Transmission Electron Microscopy Image Generation Using Diffusion Probabilistic Models for Data-Limited Semiconductor Metrology**
   - Source: arXiv, 2026-06-23
...
45. **SegmentAnyTreeV2: Scaling Transformer-Based Tree Instance Segmentation Across Sensors, Platforms, and Forests**
...
46. **APRIL-MedSeg: A Modular Medical Image Segmentation Toolbox Embracing Modern Paradigms**
   - Source: arXiv, 2026-06-29
...
47. **RAVEN: Radar Adaptive Vision Encoders for Efficient Chirp-wise Object Detection and Segmentation**
   - Source: CVPR 2026, 2026
   - Authors: Anuvab Sen, Mir Sayeed Mohammad, Saibal Mukhopadhyay
   - Tags: computer vision
   - Links: [paper](https://openaccess.thecvf.com/content/CVPR2026/html/Sen_RAVEN_Radar_Adaptive_Vision_Encoders_for_Efficient_Chirp-wise_Object_Detection_CVPR_2026_paper.html) / [pdf](https://openaccess.thecvf.com/content/CVPR2026/papers/Sen_RAVEN_Radar_Adaptive_Vision_Encoders_for_Efficient_Chirp-wise_Object_Detection_CVPR_2026_paper.pdf)
...
48. **Hierarchical Point-Patch Fusion with Adaptive Patch Codebook for 3D Shape Anomaly Detection**
   - Source: CVPR 2026, 2026
   - Authors: Xueyang Kang, Zizhao Li, Tian Lan, Dong Gong, Kourosh Khoshelham et al.
   - Tags: depth/geometry, anomaly/OOD
   - Links: [paper](https://openaccess.thecvf.com/content/CVPR2026/html/Kang_Hierarchical_Point-Patch_Fusion_with_Adaptive_Patch_Codebook_for_3D_Shape_CVPR_2026_paper.html) / [pdf](https://openaccess.thecvf.com/content/CVPR2026/papers/Kang_Hierarchical_Point-Patch_Fusion_with_Adaptive_Patch_Codebook_for_3D_Shape_CVPR_2026_paper.pdf)
...
49. **Unifying Foundation Model and Segment Anything Model for Remote Sensing Weakly Supervised Semantic Segmentation**
   - Source: Semantic Scholar / IEEE International Conference on Systems, Man and Cybernetics, 2025-10-05
   - Authors: Jinfeng Cui, Ming-Tai Wu, Zhi Li, Liang Yao, Yijun Wang et al.
   - Tags: unsupervised, SAM, boundary/frequency, remote sensing
   - Links: [paper](https://www.semanticscholar.org/paper/223e6d44e3152b647214e46d0ff681eba86e86d8)
   - 论文：Unifying Foundation Model and Segment Anything Model for Remote Sensing Weakly Supervised Semantic Segmentation
   - 一句话总结：Due to its reliance on fewer precise annotations, weakly supervised semantic segmentation (WSSS) techniques are in high demand in the field of remote sensing (RS) image processing. Despite mainstream WSSS appr...
   - 任务设定：基础模型驱动的视觉定位/分割/推理，可用于自动提示生成或 mask 筛选。
   - 方法核心：提示学习或提示生成，重点看文本/视觉 prompt 如何约束定位。
   - 实验结论：可能包含新数据集/基准；适合看评测协议、失败案例和是否能服务 COD。
   - 和我课题的关系：可补充 COD 中纹理、边界、几何先验不足的问题。
...
50. **SubspaceAD: Training-Free Few-Shot Anomaly Detection via Subspace Modeling**
...
51. **Crane: Context-Guided Prompt Learning and Attention Refinement for Zero-Shot Anomaly Detection**
...
52. **Exploring Efficient Open-Vocabulary Segmentation in the Remote Sensing**
...
53. **Annotation-Free Open-Vocabulary Segmentation for Remote-Sensing Images**
...
57. **SemiSAM-O1: How far can we push the boundary of annotation-efficient medical image segmentation?**
   - Source: arXiv, 2026-04-27
...
58. **Adapting Foundation Models for Annotation-Efficient Adnexal Mass Segmentation in Cine Images**
...
59. **HyPiDecoder: Hybrid Pixel Decoder for Efficient Segmentation and Detection**
   - Source: ICCV 2025, 2025
   - Authors: Fengzhe Zhou, Humphrey Shi
   - Tags: computer vision
   - Links: [paper](https://openaccess.thecvf.com/content/ICCV2025/html/Zhou_HyPiDecoder_Hybrid_Pixel_Decoder_for_Efficient_Segmentation_and_Detection_ICCV_2025_paper.html) / [pdf](https://openaccess.thecvf.com/content/ICCV2025/papers/Zhou_HyPiDecoder_Hybrid_Pixel_Decoder_for_Efficient_Segmentation_and_Detection_ICCV_2025_paper.pdf)
...
60. **Flood Mapping from RGB imagery using a Vision Foundation Model**
   - Source: arXiv, 2026-06-23
